...
public class Users implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        var user1 = this.userRepository.save(UserModel.builder()
                ...
                .build());
        var user2 =this.userRepository.save(UserModel.builder()
                ...
                .build());
        var user3 =this.userRepository.save(UserModel.builder()
                ...
                .build());
        var user4 =this.userRepository.save(UserModel.builder()
                ...
                .build());
        var user5 =this.userRepository.save(UserModel.builder()
                ...
                .build());
        var user6 =this.userRepository.save(UserModel.builder()
                ...
                .build());
        var userCourse1 = UserCourseModel
                .builder()
                .courseId(UUID.fromString("090e97ad-e33c-486d-a58d-fcdd3bee7522"))
                .userModel(user1)
                .build();
        var userCourse2 = UserCourseModel
                .builder()
                .courseId(UUID.fromString("090e97ad-e33c-486d-a58d-fcdd3bee7522"))
                .userModel(user2)
                .build();

        var userCourse3 = UserCourseModel
                .builder()
                .courseId(UUID.fromString("ed72bbbe-c0c1-4dce-868b-72625322c1ff"))
                .userModel(user3)
                .build();
        var userCourse4 = UserCourseModel
                .builder()
                .courseId(UUID.fromString("ed72bbbe-c0c1-4dce-868b-72625322c1ff"))
                .userModel(user4)
                .build();
        var userCourse5 = UserCourseModel
                .builder()
                .courseId(UUID.fromString("ed72bbbe-c0c1-4dce-868b-72625322c1ff"))
                .userModel(user5)
                .build();
